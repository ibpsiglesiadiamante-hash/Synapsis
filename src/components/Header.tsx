  ...
  return (
    <header className="header fixed top-0 left-0 right-0 h-[60px] bg-white border-b border-slate-200 flex items-center px-4.5 gap-3.5 z-50 shadow-sm theme-bg-surface theme-border">
      ...
      <div className="flex items-center gap-3">
        ...
        <div 
          onClick={onLogout}
          className="header-user flex items-center gap-2.5 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 p-1.5 px-2 rounded-lg transition-colors group border border-slate-200 dark:border-slate-700"
          title="Hacer clic para cerrar sesión y volver al Portal de Acceso / Nuevo Estudiante"
        >
          <div 
          ...
          <div className="user-info text-left hidden sm:block">
            <div className="user-name text-[13px] font-semibold leading-tight text-slate-800 dark:text-slate-200">
          ...
          <button
            type="button"
            className="flex items-center gap-1 text-xs font-semibold text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 px-2 py-1 rounded-md border border-rose-200 dark:border-rose-900/50 hover:bg-rose-100 transition-colors ml-1"
          >
